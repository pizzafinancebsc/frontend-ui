...
import { Card, CardBody, Heading, OpenNewIcon, Text, Link as UIKitLink, Progress } from '@pizzafinance/ui-sdk'
  ...
  return (
    <Card>
      <CardBody>
        ...
        <Message>{TranslateString(999, 'NFTs can be traded in for PIZZA until the above block height')}</Message>
      </CardBody>
    </Card>
  )
}
